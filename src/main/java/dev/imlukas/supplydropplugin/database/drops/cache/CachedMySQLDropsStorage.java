        ...
        return runQueryAsync(FETCH_CACHED, resultSet -> {
            ...
            while (resultSet.next()) {
                ...
                if (dropLocation != null) {
                    ...
                    dropLocation = DropLocation.deserialize(location); // Player location
                }
                ...
                String particleType = configurationSection.getString("particle", "circle");

                ConfigurableDrop drop = ConfigurableDrop.create(plugin, dropUUID, typeId, displayName, modelId, particleType, commandAction);
                locationTracker.track(drop, dropLocation);
